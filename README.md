...
Metro Journey Planner is a full-stack web application that helps users plan their Hyderabad Metro journeys efficiently. It provides the shortest route between stations, calculates estimated travel time, and displays an interactive metro map.
